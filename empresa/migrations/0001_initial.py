# Generated by Django 4.1.3 on 2022-11-09 03:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tecnologias_dominadas', models.ManyToManyField(to='empresa.tecnologia')),
                ('tecnologias_estudar', models.ManyToManyField(related_name='estudar', to='empresa.tecnologia')),
            ],
        ),
        migrations.AddField(
            model_name='empresa',
